...
class Interface:
    ...
    #  keyboard = kb(frame_keyboard, tb.Textboxes(root).text_field())
    ...
    pitch_value = Text(toolbar, font=[style_font, font_size], height=1, width=7).place(x=600, y=8)
