...
class Menu:
    ...
    def show_menu(self):
        ...
        global open_file
        open_file = Button(self.root, text="Abrir", width=5, height=1, font=("Arial", 12), border=0, background="#07C7F2", foreground="white", command=fm().select_file)
        ...
        global save_file
        save_file = Button(self.root, text="Salvar", width=5, height=1, font=("Arial", 12), border=0, background="#07C7F2", foreground="white", command=fm().save_file)
