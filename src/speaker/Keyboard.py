...
def __init__(self, root):
    ...
    ButtonQ = tk.Button(root, text="q", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("q", text_field, 0,300, root)).place(x=0, y=300)
    ButtonW = tk.Button(root, text="w", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("w", text_field, 25,300, root)).place(x=25, y=300)
    ButtonE = tk.Button(root, text="e", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("e", text_field, 50, 300, root))
    ButtonE.bind("<Button-3>", lambda event: fk.control_accents("e", 50, 300, root, text_field))
    ButtonE.place(x=50, y=300)
    ButtonR = tk.Button(root, text="r", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("r", text_field, 75, 300, root)).place(x=75, y=300)
    ButtonT = tk.Button(root, text="t", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("t", text_field, 100, 30, root)).place(x=100, y=300)
    ButtonY = tk.Button(root, text="y", height=2, width=2, background="light blue",
                        command=lambda:fk.control_button("y", text_field, 125, 30, root)).place(x=125, y=300)
    ButtonU = tk.Button(root, text="u", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("u", text_field, 150, 30, root)).place(x=150, y=300)
    ButtonI = tk.Button(root, text="i", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("i", text_field, 175, 30, root))
    ButtonI.bind("<Button-3>", lambda event: fk.control_accents("i", 175, 300, root, text_field))
    ButtonI.place(x=175, y=300)
    ButtonO = tk.Button(root, text="o", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("o", text_field, 200, 30, root))
    ButtonO.bind("<Button-3>", lambda event: fk.control_accents("o", 200, 300, root, text_field))
    ButtonO.place(x=200, y=300)
    ButtonP = tk.Button(root, text="p", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("p", text_field, 225, 30, root)).place(x=225, y=300)
    ...
    ButtonA = tk.Button(root, text="a", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("a", text_field, 0, 345, root))
    ButtonA.bind("<Button-3>", lambda event: fk.control_accents("a", 0, 345, root, text_field))
    ButtonA.place(x=0, y=345)
    ButtonS = tk.Button(root, text="s", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("s", text_field, 25, 345, root)).place(x=25, y=345)
    ButtonD = tk.Button(root, text="d", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("d", text_field, 50, 345, root)).place(x=50, y=345)
    ButtonF = tk.Button(root, text="f", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("f", text_field, 75, 345, root)).place(x=75, y=345)
    ButtonG = tk.Button(root, text="g", height=2, width=2, background="light blue",
                        command=lambda:fk.control_button("g", text_field, 100,345, root)).place(x=100, y=345)
    ButtonH = tk.Button(root, text="h", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("h", text_field, 125,345, root)).place(x=125, y=345)
    ButtonJ = tk.Button(root, text="j", height=2, width=2, background="light blue",
                        command=lambda:fk.control_button("j", text_field, 150,345, root)).place(x=150, y=345)
    ButtonK = tk.Button(root, text="k", height=2, width=2, background="light blue",
                        command=lambda:fk.control_button("k", text_field, 175,345, root)).place(x=175, y=345)
    ButtonL = tk.Button(root, text="l", height=2, width=2, background="light blue",
                        command=lambda:fk.control_button("l", text_field, 200,345, root)).place(x=200, y=345)
    Buttonç = tk.Button(root, text="ç", height=2, width=2, background="light blue",
                        command=lambda:fk.control_button("ç", text_field, 225,345, root)).place(x=225, y=345)
    ...
    ButtonZ = tk.Button(root, text="z", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("z", text_field, 0,390, root)).place(x=0, y=390)
    ButtonX = tk.Button(root, text="x", height=2, width=2, background="light blue",
                        command=lambda:fk.control_button("x", text_field, 25,390, root)).place(x=25, y=390)
    ButtonC = tk.Button(root, text="c", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("c", text_field, 50,390, root)).place(x=50, y=390)
    ButtonV = tk.Button(root, text="v", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("v", text_field, 75,390, root)).place(x=75, y=390)
    ButtonB = tk.Button(root, text="b", height=2, width=2, background="light blue",
                        command=lambda: fk.control_button("b", text_field, 100,390, root)).place(x=100, y=390)
    ButtonN = tk.Button(root, text="n", height=2, width=2, background="light blue",
                        command=lambda:fk.control_button("n", text_field, 125, 390, root)).place(x=125, y=390)
    ButtonM = tk.Button(root, text="m", height=2, width=2, background="light blue",
                        command=lambda:fk.control_button("m", text_field,150,390, root)).place(x=150, y=390)
